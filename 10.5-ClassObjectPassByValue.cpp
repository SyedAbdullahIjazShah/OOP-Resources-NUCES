...
//int Compare(Rectangle lhs, Rectangle rhs) what about this???

//int Rectangle::Compare(Rectangle rhs(r2) )
//int Rectangle::Compare(Rectangle rhs=r2)
int Rectangle::Compare(Rectangle rhs)	//Rectangle Pass by Value
{
	int areaLhs = Area();		//this->Area() Area of this object, for which the function has been called (Left hand side object)
...
Rectangle::~Rectangle()
{
	cout << "\nDestructor Called for "<<this<<" Rectangle " << lenght << "X" << width << endl;
}
